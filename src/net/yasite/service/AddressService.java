...
import net.zuoye.api.AddAddressAPI;
import net.zuoye.api.BaseAPI;
import net.zuoye.api.DeleteAddressAPI;
import net.zuoye.api.GetAddressInfoAPI;
import net.zuoye.api.GetAddressListAPI;
import net.zuoye.api.params.AddressParams;
